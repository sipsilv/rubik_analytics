...
"""`,
            ...
            const standardModels = [
                'llama3', 'llama3:70b', 'llama2', 'mistral', 'mixtral', 'gemma', 'phi3',
    ...
    return (
        ...
        >
            <div
                className="bg-[#121b2f] border border-[#1f2a44] rounded-xl shadow-2xl w-full max-w-2xl flex flex-col max-h-[90vh] overflow-hidden"
                style={{
            ...
            >
                {/* Header */}
                <div className="flex items-center justify-between px-6 py-4 border-b border-[#1f2a44] bg-[#1a2332]/50">
                    <div>
                    ...
                    <button
                        onClick={handleClose}
                        className="text-[#9ca3af] hover:text-white transition-colors p-2 hover:bg-[#1f2a44] rounded-lg"
                    >
                        <X className="w-5 h-5" />
                    </button>
                </div>
